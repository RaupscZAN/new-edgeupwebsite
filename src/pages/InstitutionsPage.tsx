  ...
  const successStories = [
    {
      ...
      quote: "EdgeUp helped us increase our UPSC selection rate by 28% in just one year.",
      director: "Rajiv Sharma, Director",
      image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1600",
      stats: { improvement: 28, students: 500 }
    },
    {
      institution: "NextGen Learning Solutions",
      quote: "The adaptive testing technology has transformed how we assess and support our students.",
      director: "Priya Patel, CEO",
      image: "https://images.pexels.com/photos/3184317/pexels-photo-3184317.jpeg?auto=compress&cs=tinysrgb&w=1600",
      stats: { improvement: 35, students: 750 }
    },
    {
      institution: "Achievers NEET Academy",
      quote: "Our students' performance improved significantly with EdgeUp's personalized learning paths.",
      director: "Anil Kumar, Founder",
      image: "https://images.pexels.com/photos/3184325/pexels-photo-3184325.jpeg?auto=compress&cs=tinysrgb&w=1600",
      stats: { improvement: 42, students: 300 }
    }
  ];
                ...
                <div key={index} className="feature-card hover-lift animate-scale-in" style={{ animationDelay: `${index * 0.1}s` }}>
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-muted">{benefit.stat.label}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {successStories.map((story, index) => (
                <div key={index} className="bg-white rounded-xl shadow-sm overflow-hidden hover-lift animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold mb-2">{story.institution}</h3>
                    <blockquote className="text-muted mb-4 italic">"{story.quote}"</blockquote>
                    <p className="text-sm text-gray-500 mb-4">- {story.director}</p>
                    
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#10ac8b]">
                          <AnimatedCounter end={story.stats.improvement} suffix="%" />
                        </div>
                        <div className="text-xs text-muted">Improvement</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#094d88]">
                          <AnimatedCounter end={story.stats.students} />
                        </div>
