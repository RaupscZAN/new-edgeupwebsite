        ...
        <section className="section-padding bg-white">
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Contact Information */}
              <div className="bg-[#094d88] text-white p-8 rounded-xl">
                <h2 className="text-2xl font-bold mb-6">Contact Information</h2>
                
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <Mail className="h-6 w-6 text-[#10ac8b] mt-1" />
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    <Phone className="h-6 w-6 text-[#10ac8b] mt-1" />
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    <MapPin className="h-6 w-6 text-[#10ac8b] mt-1" />
                    <div>
                ...
                {submitSuccess ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center px-6 py-3 bg-[#094d88] text-white font-semibold rounded-lg hover:bg-[#073a6b] transition-all duration-300 hover:scale-105"
                    >
